        ...
        return new Promise((resolve, reject) => {
            ...
            channel.port1.onmessage = ({ data }) => {
                ...
                if (!(data === null || data === void 0 ? void 0 : data.success)) {
                    ...
                    cancelStream();
                    if (streamController) {
                        streamController.error((data === null || data === void 0 ? void 0 : data.error) ? JSON.parse(data.error) : new Error("Stream failed"));
                    }
                    else {
                        reject((data === null || data === void 0 ? void 0 : data.error) ? JSON.parse(data.error) : null);
                    }
                    return;
                }
                ...
                else if ((data === null || data === void 0 ? void 0 : data.chunk) !== undefined) {
                    streamController === null || streamController === void 0 ? void 0 : streamController.enqueue(data.chunk);
                }
            };
        });
    };
