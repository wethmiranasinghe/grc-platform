...
export class AsgardeoSPAClient {
     ...
     * @preserve
     */
    httpStreamRequest(config) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._validateMethod(false);
            if (this._storage !== Storage.WebWorker) {
                throw new AsgardeoAuthException("SPA-AUTH_CLIENT-HSR-IV01", "Streaming is only supported with WebWorker storage.", "The httpStreamRequest method requires storage type to be set to webWorker.");
            }
            const webWorkerClient = this._client;
